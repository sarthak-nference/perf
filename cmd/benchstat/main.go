...
// https://my_stats.go.dev/github.com/sarthak-nference/perf/benchproc/syntax.
//
// # Projection examples
//
...
// configuration, consisting of "goos", "goarch", and "my_stats", so
...
import (
	...
	"github.com/sarthak-nference/perf/cmd/benchstat/my_stats/benchtab"
)
...
For details, see https://my_stats.go.dev/github.com/sarthak-nference/perf/cmd/benchstat.
`)
		flags.PrintDefaults()
	}
